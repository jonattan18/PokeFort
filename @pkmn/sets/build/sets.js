...
exports._import = exports._unpack = exports.Sets = exports.toID = void 0;
function toID(s) {
...
exports.Sets = new class {
    pack(s) {
        return exports.Sets.packSet(s);
    }
    packSet(s) {
        let buf = '';
        // name
        ...
        const getIV = (stat) => !('ivs' in s) || s.ivs[stat] === 31 || s.ivs[stat] === undefined
            ? ''
            : s.ivs[stat].toString();
        // ivs
        let ivs = '|';
    ...
    exportSet(s, data) {
        ...
        species = ((_a = data === null || data === void 0 ? void 0 : data.species.get(species)) === null || _a === void 0 ? void 0 : _a.name) || species;
        ...
        if (s.item) {
            const item = (_c = (_b = data === null || data === void 0 ? void 0 : data.items.get(s.item)) === null || _b === void 0 ? void 0 : _b.name) !== null && _c !== void 0 ? _c : s.item;
            buf += ' @ ' + item;
        }
        buf += '  \n';
        if (s.ability && (!data || (data === null || data === void 0 ? void 0 : data.gen) >= 3)) {
            const ability = (_e = (_d = data === null || data === void 0 ? void 0 : data.abilities.get(s.ability)) === null || _d === void 0 ? void 0 : _d.name) !== null && _e !== void 0 ? _e : s.ability;
            buf += 'Ability: ' + ability + '  \n';
        }
        if (s.level && s.level !== 100) {
            buf += 'Level: ' + s.level + '  \n';
        ...
        if (s.moves) {
            for (let move of s.moves) {
                if (move) {
                    move = (_g = (_f = data === null || data === void 0 ? void 0 : data.moves.get(move)) === null || _f === void 0 ? void 0 : _f.name) !== null && _g !== void 0 ? _g : move;
                    buf += '- ' + exportMove(move) + '  \n';
                }
            }
        }
    ...
    unpack(buf, data) {
        return exports.Sets.unpackSet(buf, data);
    }
    unpackSet(buf, data) {
    ...
    toString(s, data) {
        return exports.Sets.exportSet(s, data);
    }
    fromString(str) {
        return exports.Sets.importSet(str);
    }
};
...
function _unpack(buf, i = 0, j = 0, data) {
    ...
    if (j < 0)
        return { i, j };
    s.species = unpackName(buf.substring(i, j), data === null || data === void 0 ? void 0 : data.species) || s.name;
    i = j + 1;
    // item
    j = buf.indexOf('|', i);
    if (j < 0)
        return { i, j };
    s.item = unpackName(buf.substring(i, j), data === null || data === void 0 ? void 0 : data.items);
    i = j + 1;
    // ability
    j = buf.indexOf('|', i);
    if (j < 0)
        return { i, j };
    let ability = unpackName(buf.substring(i, j), data === null || data === void 0 ? void 0 : data.abilities);
    if (ability === '-') {
        ability = '';
    }
        ...
        if (data) {
            ...
            if ((species === null || species === void 0 ? void 0 : species.baseSpecies) === 'Zygarde' && ability === 'H') {
                ability = 'Power Construct';
            }
            else if (species === null || species === void 0 ? void 0 : species.abilities) {
    ...
    if (j < 0)
        return { i, j };
    s.moves = buf.substring(i, j).split(',', 24).filter(x => x).map(m => unpackName(m, data === null || data === void 0 ? void 0 : data.moves));
    i = j + 1;
    // nature
    j = buf.indexOf('|', i);
    if (j < 0)
        return { i, j };
    s.nature = unpackName(buf.substring(i, j), data === null || data === void 0 ? void 0 : data.natures);
    i = j + 1;
    // evs
    j = buf.indexOf('|', i);
    if (j < 0)
    ...
    if (j < 0) {
        if (i < buf.length)
            misc = buf.substring(i).split(',', 4);
    }
    else {
        if (i !== j)
            misc = buf.substring(i, j).split(',', 4);
    }
    if (misc) {
        s.happiness = (misc[0] ? Number(misc[0]) : 255);
        s.hpType = misc[1] || '';
        s.pokeball = unpackName(misc[2] || '', data === null || data === void 0 ? void 0 : data.items);
        s.gigantamax = !!misc[3];
    }
    return { set: s, i, j };
}
exports._unpack = _unpack;
    ...
    for (; i < lines.length; i++) {
        ...
        if (line === '' || line === '---' || line.substr(0, 3) === '===' ||
            ...
            if (line.substr(line.length - 1) === ')' && parenIndex !== -1) {
                ...
                s.species = (_b = (_a = data === null || data === void 0 ? void 0 : data.species.get(sub)) === null || _a === void 0 ? void 0 : _a.name) !== null && _b !== void 0 ? _b : sub;
                line = line.substr(0, parenIndex);
                s.name = line;
            }
            else {
                s.species = (_d = (_c = data === null || data === void 0 ? void 0 : data.species.get(line)) === null || _c === void 0 ? void 0 : _c.name) !== null && _d !== void 0 ? _d : line;
                s.name = '';
            }
        }
...
function getHiddenPowerIVs(hpType, data) {
    ...
    if (!hp)
        return undefined;
    return (data === null || data === void 0 ? void 0 : data.gen) === 2 ? DVsToIVs(hp.dvs) : hp.ivs;
}
