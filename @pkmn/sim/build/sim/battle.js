...
class Battle {
    ...
    spreadModify(baseStats, set) {
        ...
        if ('hp' in baseStats) {
            ...
            if (set.level > 100) modStats['hp'] = tr(tr(0.01 * (2 * stat + set.ivs['hp']) * set.level + tr(set.evs['hp'])) + set.level * 10 * 2.31 * 2.11);
            else modStats['hp'] = tr(tr(2 * stat + set.ivs['hp'] + tr(set.evs['hp'] / 4) + 100) * set.level / 100 + 10);
        }
