...
export declare type Battle = import('./battle').Battle;
export declare type BattleQueue = import('./battle-queue').BattleQueue;
export declare type BattleActions = import('./battle-actions').BattleActions;
export declare type Field = import('./field').Field;
export declare type Action = import('./battle-queue').Action;
export declare type MoveAction = import('./battle-queue').MoveAction;
export declare type ActionChoice = import('./battle-queue').ActionChoice;
export declare type ModdedDex = import('./dex').ModdedDex;
export declare type Pokemon = import('./pokemon').Pokemon;
export declare type PRNGSeed = import('./prng').PRNGSeed;
export declare type Side = import('./side').Side;
export declare type TeamValidator = import('./team-validator').TeamValidator;
export declare type PokemonSources = import('./team-validator').PokemonSources;
/** An ID must be lowercase alphanumeric. */
export declare type ID = '' | string & {
    __isID: true;
};
export declare type PokemonSlot = '' | string & {
    __isSlot: true;
};
...
export declare type StatsExceptHPTable = {
    [stat in StatIDExceptHP]: number;
};
export declare type StatsTable = {
    [stat in StatID]: number;
};
export declare type SparseStatsTable = Partial<StatsTable>;
export declare type BoostID = StatIDExceptHP | 'accuracy' | 'evasion';
export declare type BoostsTable = {
    [boost in BoostID]: number;
};
export declare type SparseBoostsTable = Partial<BoostsTable>;
export declare type Nonstandard = 'Past' | 'Future' | 'Unobtainable' | 'CAP' | 'LGPE' | 'Custom' | 'Gigantamax';
export declare type PokemonSet = import('./teams').PokemonSet;
/**
 ...
 */
export declare type MoveSource = string;
...
export declare type Effect = Ability | Item | ActiveMove | Species | Condition | Format;
...
export declare type ModdedEffectData = EffectData | Partial<EffectData> & {
    inherit: true;
};
export declare type EffectType = 'Condition' | 'Pokemon' | 'Move' | 'Item' | 'Ability' | 'Format' | 'Nature' | 'Ruleset' | 'Weather' | 'Status' | 'Rule' | 'ValidatorRule';
...
export declare type ConditionData = import('./dex-conditions').ConditionData;
export declare type ModdedConditionData = import('./dex-conditions').ModdedConditionData;
export declare type Condition = import('./dex-conditions').Condition;
export declare type MoveData = import('./dex-moves').MoveData;
export declare type ModdedMoveData = import('./dex-moves').ModdedMoveData;
export declare type ActiveMove = import('./dex-moves').ActiveMove;
export declare type Move = import('./dex-moves').Move;
export declare type MoveTarget = import('./dex-moves').MoveTarget;
export declare type ItemData = import('./dex-items').ItemData;
export declare type ModdedItemData = import('./dex-items').ModdedItemData;
export declare type Item = import('./dex-items').Item;
export declare type AbilityData = import('./dex-abilities').AbilityData;
export declare type ModdedAbilityData = import('./dex-abilities').ModdedAbilityData;
export declare type Ability = import('./dex-abilities').Ability;
export declare type SpeciesData = import('./dex-species').SpeciesData;
export declare type ModdedSpeciesData = import('./dex-species').ModdedSpeciesData;
export declare type SpeciesFormatsData = import('./dex-species').SpeciesFormatsData;
export declare type ModdedSpeciesFormatsData = import('./dex-species').ModdedSpeciesFormatsData;
export declare type LearnsetData = import('./dex-species').LearnsetData;
export declare type ModdedLearnsetData = import('./dex-species').ModdedLearnsetData;
export declare type Species = import('./dex-species').Species;
export declare type FormatData = import('./dex-formats').FormatData;
export declare type FormatList = import('./dex-formats').FormatList;
export declare type ModdedFormatData = import('./dex-formats').ModdedFormatData;
export declare type Format = import('./dex-formats').Format;
export interface NatureData {
    name: string;
    plus?: StatIDExceptHP;
    minus?: StatIDExceptHP;
}
export declare type ModdedNatureData = NatureData | Partial<Omit<NatureData, 'name'>> & {
    inherit: true;
};
export declare type Nature = import('./dex-data').Nature;
export declare type GameType = 'singles' | 'doubles' | 'triples' | 'rotation' | 'multi' | 'freeforall';
export declare type SideID = 'p1' | 'p2' | 'p3' | 'p4';
...
export declare type SpreadMoveTargets = (Pokemon | false | null)[];
export declare type SpreadMoveDamage = (number | boolean | undefined)[];
export declare type ZMoveOptions = ({
    move: string;
    target: MoveTarget;
} | null)[];
...
export declare type ModdedTypeData = TypeData | Partial<Omit<TypeData, 'name'>> & {
    inherit: true;
};
export declare type TypeInfo = import('./dex-data').TypeInfo;
