...
export interface EventMethods {
    ...
    onTryHeal?: (((this: Battle, relayVar: number, target: Pokemon, source: Pokemon, effect: Effect) => number | boolean | void) | ((this: Battle, pokemon: Pokemon) => boolean | void) | boolean);
...
export declare type ConditionData = PokemonConditionData | SideConditionData | FieldConditionData;
export declare type ModdedConditionData = ConditionData & {
    inherit?: true;
};
