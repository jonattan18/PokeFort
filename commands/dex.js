...
function create_pagination(message, dex_pokemons, description_string = "", field_prefix = "", page = 0, total_pokemons_uncaught = 0, orderd = false) {
    ...
    for (i = 0; i < global_embed.length; i++) {
        if (total_pokemons_uncaught > 0) { global_embed[i].setDescription(`You have caught ${dex_pokemons.length - total_pokemons_uncaught} out of ${dex_pokemons.length} ${description_string}pokemons.\n`); }
        else if (not_caught_count == 0) { global_embed[i].setDescription("You have caught all pokemons."); }
        else { global_embed[i].setDescription(`You have caught ${dex_pokemons.length - total_pokemons_uncaught} out of ${dex_pokemons.length} ${description_string}pokemons.\n`); }
    }
