...
function page_6(message, balance, prefix) {
    ...
    embed.setTitle(`:moneybag: Balance: ${balance}\n\nForms`)
    embed.setColor(message.guild.me.displayHexColor)
    embed.setDescription(`Some pokemon have different forms, you can buy items here to allow them to transform.\n\n**All form items cost 500 credits.**`)
    embed.addField('Deoxys Normal Form', '``' + prefix + 'buy deoxys normal form``', true)
    embed.addField('Deoxys Attack Form', '``' + prefix + 'buy deoxys attack form``', true)
    embed.addField('Deoxys Defense Form', '``' + prefix + 'buy deoxys defense form``', true)
    embed.addField('Deoxys Speed Form', '``' + prefix + 'buy deoxys speed form``', true)
    embed.addField('Base Necrozma', '``' + prefix + 'buy necrozma regular``', true)
    embed.addField('Dusk Mane Necrozma', '``' + prefix + 'buy necrozma dusk mane``', true)
    embed.addField('Dawn Wings Necrozma', '``' + prefix + 'buy necrozma dawn wings``', true)
    embed.addField('Ultra Necrozma', '``' + prefix + 'buy necrozma ultra``', true)
    embed.setFooter("Need more credits ? Win duels or vote for the bot using the " + prefix + "daily command!")
    message.channel.send(embed)
}
