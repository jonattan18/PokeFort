...
function raid(raid_data, bot, interaction, user_available, pokemons, _switch, _default = false, raid_function_health = 5) {
    ...
    var except_five = false;
    if (parsed_stream.length > 5) {
        except_five = true;
    ...
    var move_index = move_thinker(_battlestream.battle);
