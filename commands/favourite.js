    ...
    for (a = 0; a < chunked_pokemons.length; a++) {
        ...
        for (i = 0; i < chunked_pokemons[a].length; i++) {
            ...
            if (chunked_pokemons[a][i].Nickname != undefined) {
                description += `\n**${pokemon_name}** | Level: ${chunked_pokemons[a][i].Level} | Number: ${pokemon_number + 1} | IV: ${total_iv}% | Nickname: ${chunked_pokemons[a][i].Nickname}\n`;
            }
            else { description += `\n**${pokemon_name}** | Level: ${chunked_pokemons[a][i].Level} | Number: ${pokemon_number + 1} | IV: ${total_iv}%\n`; }
        }
